...
const Footer = () => (
  <footer className="site-footer">
    <p>© {new Date().getFullYear()} Urfa Grill. All Rights Reserved.<br />Website Developed By <a href="https://manueldinisjunior.de/" target="_blank" rel="noreferrer">Manuel Dinis Júnior</a></p>
